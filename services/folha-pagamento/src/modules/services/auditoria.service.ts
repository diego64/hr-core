...
/**
 * Wrapper fino sobre o repo. Existe para isolar o domínio do tipo do request
 * (ip/userAgent vêm do middleware HTTP) e pra centralizar logs futuros
 * (eventualmente: alerta no Grafana se valorAnterior == valorNovo).
 */
