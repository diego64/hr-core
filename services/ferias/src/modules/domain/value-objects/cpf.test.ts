...
import { gerarCodigoFerias } from './codigo-ferias.js'
...
describe('gerarCodigoFerias', () => {
  it.each([
    [1, 'FER000001'],
    [42, 'FER000042'],
    [999_999, 'FER999999'],
    [1_000_000, 'FER1000000'], // cresce além de 6 dígitos
  ])('sequencia %i → %s', (seq, esperado) => {
    expect(gerarCodigoFerias(seq)).toBe(esperado)
  })
})
